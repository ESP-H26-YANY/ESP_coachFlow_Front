...
export default function CoachProfile() {
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Mon Profil Coach</h1>
      ...
      <div className="bg-white dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm space-y-4">
        ...
        <p className="text-lg"><strong>ID :</strong> <span className="text-sm text-gray-500 font-mono">{user?.id}</span></p>
        <p className="text-lg"><strong>Email :</strong> {user?.email}</p>
        <p className="text-lg"><strong>Rôle :</strong> {user?.role}</p>
        ...
        <div className="pt-4 mt-4 border-t border-gray-200 dark:border-gray-700">
          ...
          <Button color="purple" onClick={handleTopup} disabled={isLoading}>
            ...
            Ajouter 50 $ depuis mon compte bancaire
          </Button>
        </div>
      </div>
    </div>
